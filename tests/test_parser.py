...
from app.api.parser import (
    find_poster_image_src,
    find_movie_photos_src,
...
class TestParser:
    ...
    @pytest.mark.parametrize(
        ...
        [
            [
                "https://m.media-amazon.com/images/M/MV5BY2IzNzMxZjctZjUxZi00YzAxLTk3ZjMtODFjODdhMDU5NDM1XkEyXkFqcGc@._V1_QL75_UX190_CR0,8,190,281_.jpg",
                "https://m.media-amazon.com/images/M/MV5BY2IzNzMxZjctZjUxZi00YzAxLTk3ZjMtODFjODdhMDU5NDM1XkEyXkFqcGc@._V1_QL75.jpg",
            ],
            ["1234", "1234"],
            [
                "http://localhost:8000/image/test@QWERTY.jpg",
                "http://localhost:8000/image/test@._V1_QL75.jpg",
            ],
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                "https://m.media-amazon.com/images/M/MV5BMjI3MTU0ODQ2MF5BMl5BanBnXkFtZTcwNTQzNTIwNA@@._V1_QL75_UX321_.jpg",
                "https://m.media-amazon.com/images/M/MV5BMjI3MTU0ODQ2MF5BMl5BanBnXkFtZTcwNTQzNTIwNA@@._V1_QL75.jpg",
            ],
        ],
    )
